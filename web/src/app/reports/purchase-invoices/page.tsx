...
import { usePurchaseInvoicesReport } from "@/hooks/useApi";
...
export default function PurchaseInvoicesPage() {
  ...
  const report = usePurchaseInvoicesReport(year, period, periodType);
        ...
        <main className="flex-1">
          <header className="border-b bg-white">
            <div className="flex items-center justify-between px-6 py-4">
              <div>
                ...
                <h1 className="text-2xl font-semibold">Purchase Invoices Report</h1>
              </div>
          ...
          <div className="flex flex-wrap items-end gap-3 rounded-lg border bg-white p-4">
            ...
            {generated && report.data && (
              <button className="ml-auto inline-flex h-10 items-center gap-2 rounded-md border px-4 text-sm hover:bg-slate-100">
                <Download size={15} />
                Export Excel
              </button>
            )}
                ...
                <table className="w-full min-w-[1200px] text-left text-sm">
                  ...
                  <tbody>
                    ...
                    {!report.isFetching && paginatedItems.length === 0 && (
                      <tr>
                        <td className="px-3 py-8 text-center text-slate-500" colSpan={11}>
                          No purchase invoices for {periodLabel}.
                        </td>
                      </tr>
                    )}
          ...
          {!generated && (
            <div className="rounded-lg border border-dashed border-slate-300 bg-white p-12 text-center text-slate-500">
              Select a period and click "Generate" to view purchase invoices.
            </div>
          )}
        </section>
        </main>
