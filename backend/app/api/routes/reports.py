    ...
    for invoice in invoices:
        ...
        if direction == "purchase":
            ...
            if invoice.vat_rate == VATRate.EXEMPT:
                ...
                # HTKK maps the temporary 8% relief invoices into the [32]/[33] standard bucket.
...
def _invoice_report_row(index: int, inv: Invoice, company: Company) -> dict:
    ...
    return {
        ...
        "vat_rate": inv.vat_rate.value if hasattr(inv.vat_rate, "value") else str(inv.vat_rate),
...
def _build_vat_workbook(summary: dict, company: Company) -> BytesIO:
    ...
    declaration_sheet.append(["Ky khai thue", _period_label(summary["period_type"], summary["period"], summary["year"]), "", "Han nop", summary["declaration_deadline"]])
